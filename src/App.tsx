...
const App = () => {
  const portfolioData = {
    ...
    skills: {
     ...
     { name: "Azure", proficiency: 80, description: "Cloud-native services like ADF, Synapse, and Databricks", icon: 'Cloud' },
     { name: "Tableau", proficiency: 80, description: "Interactive dashboards and visual analytics", icon: 'BarChart' },
     { name: "Power BI", proficiency: 80, description: "Business dashboards, DAX, and Power Query transformations", icon: 'BarChart3' },
     { name: "Excel", proficiency: 80, description: "Pivot tables, formulas, and spreadsheet modeling", icon: 'Table' },
     ],
      pipelineExpertise: [
